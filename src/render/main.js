  ...
  return (
    ...
    >
      ...
      <div className="entry-actions" role="menubar">
        ...
        >
          <img src="./trash-outline.svg" alt="delete icon" />
        </button>
        <button
          onClickCapture={pin}
        ...
        >
          <img src="./bookmark-outline.svg" alt="pin icon" />
        </button>
        <button
          onClickCapture={copy}
        ...
        >
          <img src="./clipboard-outline.svg" alt="copy icon" />
        </button>
        <button
        ...
        >
          <img src="./checkmark-square-outline.svg" alt="select icon" />
        </button>
      </div>
    </li>
  );
...
class App extends React.Component {
  constructor(props) {
    ...
    this.copySelectionButtonRef = React.createRef();
  }
